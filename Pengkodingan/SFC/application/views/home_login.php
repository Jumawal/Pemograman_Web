            ...
            <div class="container" >
                ...
                <div class="collapse navbar-collapse navbar-right" >
                    <ul class="nav navbar-nav" >
                        <li class="active" ><a href="<?php echo base_url();?>index.php/home_login" >Home</a></li>
                        <li><a href="<?php echo base_url();?>index.php/daftar_iuran">Daftar Iuran</a></li>
                        <li><a href="<?php echo base_url();?>index.php/daftar_anggota">Anggota</a></li>
                        ...
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    ...
                                    <h2 class="animation animated-item-2">Di dalam turnament SFC beberapa tahun terakhir setelah ada konflik internal....</h2>
                                    <a class="btn-slide animation animated-item-3" href="<?php echo base_url();?>index.php/postingan">Baca selanjutnta>>></a>
                                </div>
                            </div>
