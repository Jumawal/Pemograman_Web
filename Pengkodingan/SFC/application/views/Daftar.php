...
<div class="container">
  <div class="modal" id="theModal" role="dialog">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav" >
                        ...
                        <li class="active" ><a href="<?php echo base_url();?>index.php/Daftar/tambah">Daftar</a></li>
                        <li class="dropdown">
    ...
    <body style="background: #ffffff";>
        ...
        <div id="wrap" style="float :left; font-family:bold; width: 500px; height: 500px; margin-top: 20px; background:#eee; ">
        
        <div id="content" style="padding: 20px; margin-top: 20px;">
            <center>
                
                <h3 style="color: black; font-size: 30px; font-family:bold; ">FORM PENDAFTARAN</h3>
            </center>
        <form action="<?php echo base_url().'index.php/daftar/tambah_aksi'; ; ?>" method="post">
        <table style="margin:20px auto; " >
            <tr>
                <td >Nama</td>
                <td ><input style="margin-top: 10px; margin-left: 10px; height: 28px; width: 220px;" type="text" name="nama" placeholder="nama lengkap"></td>
            </tr>
            <tr>
                <td>Nrp</td>
                <td><input style="margin-top: 10px; margin-left: 10px; height: 28px; width: 220px;" type="text" name="nrp" placeholder="nrp"></td>
            </tr>
            <tr>
                <td>Angkatan</td>
                <td><select name="angkatan" style="margin-top: 10px;margin-left: 10px; height: 28px; width: 100px;">
                    <option name="angkatan"  value="2016">2016</option>
                    <option name="angkatan"  value="2015">2015</option>
                    <option name="angkatan" value="2014">2014</option>
                    <option name="angkatan" value="2013">2013</option>
                    <option name="angkatan"  value="2012">2012</option>
                    <option name="angkatan"  value="2011">2011</option>
                    <option name="angkatan" value="2010">2010</option>
                    <option name="angkatan" value="2009">2009</option>
                    </select>
                </td>
            </tr>
            ...
            <tr>
                <td>Jurusan</td>
                <td><select name="jurusan" style="margin-top: 10px;margin-left: 10px; height: 28px; width: 175px;">
                    ...
                    <option name="jurusan" value="Desain Komunikasi Visual">Desain Komunikasi Visual</option>
                    <option name="jurusan" value="Management Informasi">Management Informasi</option>
                    </select>
                </td>
            </tr>
            <tr>
            <td >Jenis Kelamin</td>
                ...
                <td><input style="margin-top: 10px; margin-left: 10px;" type="radio" checked="checked" value="Laki-laki" name="jeniskelamin">Laki-laki
                <span class="checkmark"></span>
                <input style="margin-top: 10px;margin-left: 10px;" type="radio" checked="checked" value="wanita" name="jeniskelamin">Wanita
                <span class="checkmark"></span></td>
            </tr>
            <tr>
                <td>Tlpn</td>
                <td><input style="margin-top: 10px; margin-left: 10px; height: 28px; width: 220px;" type="text" name="tlpn" placeholder="no telphone"></td>
            </tr>
            <tr>
                <td>Alamat</td>
                <td><input style="margin-top: 10px; margin-left: 10px; height: 28px; width: 220px;" type="text" name="alamat" placeholder="alamat saat ini"></td>
            </tr>
            
             <tr>
                <td>Username</td>
                <td><input style="margin-top: 10px; margin-left: 10px; height: 28px; width: 220px;" type="text" name="username" placeholder="E-mail"></td>

            </tr>
             <tr>
                <td>Password</td>
                <td><input style="margin-top: 10px; margin-left: 10px; height: 28px; width: 220px;" type="password" name="password" placeholder="password"></td>
            </tr>
            <tr>
                <td></td>
                <td><input style="margin-top: 10px; margin-left: 10px;" type="submit" value="SIMPAN" name="submit"></td>
            </tr>
        </table>
    </form> 
        ...
        <div style="width: 366px; height: 500px; background: #ffffff; float: left;">
            <center><br><br>
