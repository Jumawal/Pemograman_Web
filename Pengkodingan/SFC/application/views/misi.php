...
<div class="container">
  <div class="modal" id="theModal" role="dialog">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav" >
                        ...
                        <li class="active" ><a href="<?php echo base_url();?>index.php/misi">Visi & Misi</a></li>
    ...
    <body style="background: #ffffff";>
        ...
        <div id="wrap" style="float :left; font-family:bold; width: 620px; height: 600px; margin-top: 20px; background:#eee; ">
        <div id="content" style="padding: 20px; margin-top: 20px; font-size: 20px; text-align: center;">
            <center>
                <h3 style="color: black; font-size: 30px; font-family:bold; ">VISI & MISI</h3>
            </center>
            <h2 style="color: black; font-family: bold; text-align: center; ">VISI</h2><br>
            <p style="color: black; text-align: center; font-size: 20px;">
                Membentuk anak-anak muda yang berkarakter, bermental kuat, berjiwa sportif dalam suasana kebersamaaan dalam rangka meraih prestasi tinggi. Menjadikan olahraga futsal sebagai pelayanan olahraga yang membawa dampak buat banyak orang.
            </p>
            <h2 style="color: black; font-family: bold; text-align: center; margin-top: 50px;">MISI</h2><br>
            1. Adanya saling mendukung di pelayanan futsal.<br>
            2. Menjadikan ukm futsal sebagai keluarga.<br>
            3. Menjadikan arena futsal berskala nasional.<br>
            4. Menjalin persaudaraan yang kokoh di antara anggota club.<br>
            5. Menerapkan mode pelatihan futsal yang baik dan terarah.<br>
            6. Memajukan futsal sebagai penyalur hobi yang baik.<br>
        </div>
        </div>
