                    ...
                    <ul class="nav navbar-nav" >
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li class="active" ><a href="<?php echo base_url();?>index.php/seminar">Seminar</a></li>
                    ...
                    <div class="blog-item">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-10 blog-content">
                                <a href="#"><img class="img-responsive img-blog" src="<?php echo base_url();?>template/images/blog/blog1.jpg" width="100%" alt="" /></a>
                    ...
                    <div class="blog-item">
                        <div class="row">
                            ...
                            <div class="col-sm-10 blog-content">
                                <a href=""><img class="img-responsive img-blog" src="<?php echo base_url();?>template/images/blog/blog2.jpg" width="100%" alt="" /></a>
                                <h2><a href="blog-item.html">Consequat bibendum quam liquam viverra</a></h2>
                                <h3>Curabitur quis libero leo, pharetra mattis eros. Praesent consequat libero eget dolor convallis vel rhoncus magna scelerisque. Donec nisl ante, elementum eget posuere a, consectetur a metus. Proin a adipiscing sapien. Suspendisse vehicula porta lectus vel semper. Nullam sapien elit, lacinia eu tristique non.posuere at mi. Morbi at turpis id urna ullamcorper ullamcorper.</h3>
                                <a class="btn btn-primary readmore" href="blog-item.html">Read More <i class="fa fa-angle-right"></i></a>
                            </div>
                ...
                <aside class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="single_comments">
                                    <img src="<?php echo base_url();?>template/images/blog/avatar3.png" alt=""  />
    				...
    				<div class="widget blog_gallery">
                        ...
                        <ul class="sidebar-gallery">
                            <li><a href="#"><img src="<?php echo base_url();?>template/images/blog/gallery1.png" alt="" /></a></li>
                            <li><a href="#"><img src="<?php echo base_url();?>template/images/blog/gallery2.png" alt="" /></a></li>
                            <li><a href="#"><img src="<?php echo base_url();?>template/images/blog/gallery3.png" alt="" /></a></li>
                            <li><a href="#"><img src="<?php echo base_url();?>template/images/blog/gallery4.png" alt="" /></a></li>
                            <li><a href="#"><img src="<?php echo base_url();?>template/images/blog/gallery5.png" alt="" /></a></li>
                            <li><a href="#"><img src="<?php echo base_url();?>template/images/blog/gallery6.png" alt="" /></a></li>
                        </ul>
                    </div><!--/.blog_gallery-->
    			</aside>  
            </div><!--/.row-->
